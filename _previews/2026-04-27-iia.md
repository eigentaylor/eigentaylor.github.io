...
The precise definition of strategyproofness is a bit technical, but I explain it in my [post on the Gibbard-Satterthwaite Theorem](../gibbard-satt/){:target="_blank"}. Suffice it to say, the gist of it is that changing your ballot should never lead to a better result according to your "true" ballot. For example, if you submit a ballot that says "I like Apple more than Blueberry", then you shouldn't be able to (or, from another perspective, *need* to) change your ballot somehow in a way that subsequently changes the winner from Blueberry to Apple. If you could do that, then you would have an incentive to lie, and a beneficial strategy.
