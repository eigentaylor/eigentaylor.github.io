...
In their seminal [1978 paper](https://doi.org/10.2307/1955105), Brams and Fishburn show that Approval voting is strategyproof on dichotomous preferences. Since Approval is also neutral, then by Lemma \ref{stratproof-iia} it must satisfy IIA on dichotomous preferences as well! Therefore, Approval's technical exception to Arrow's theorem and Gibbard's theorem is not just a technicality, but actually shows a very real and meaningful connection.
