...
If both pizza lovers find Veg n' Go to be 99% as good as Pizza Palace, then Veg n' Go is a choice that literally 100% of voters would be content with, while Pizza Palace would result in the minority being unable to eat anything at all. How is that not compromise?
...
3. If we pick Veg n' Go, then that same supermajority of voters would still be happy, and one more voter would be happy with the outcome. Only 39% of voters would be unhappy with the outcome, but they would still be unhappy with either Pizza Palace or Veg n' Go.
