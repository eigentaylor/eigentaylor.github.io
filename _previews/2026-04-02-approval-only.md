...
At this point, I am quite convinced that Approval voting is the most practical fix for our democracy. In this post, I want to explain my personal philosophy and most important criteria for evaluating electoral systems, and why Approval voting is the only option that checks all the boxes. This is a snapshot in time of my current thoughts as of approximately April 2026. I am open to changing my mind. And if you aren't convinced by my reasons and the criteria that I value, that's fine. But my framework is grounded in pure practicality and in our common goal of permanently ending Choose-one voting.

We are in a critical moment right now. RCV is facing wide backlash and is now banned in [19 states](https://ballotpedia.org/Ranked-choice_voting_(RCV)){:target="_blank"} across the country. Voters are increasingly skeptical of electoral reform, and I think we have *one* chance to pivot. If we make the wrong move now and rally behind a system that is too complex, too new, or insufficiently tested, and the voters reject it, then we may lose the opportunity to make meaningful electoral reform progress in the near future. The political capital and public trust required to push through reform are finite and waning. Let's not squander them on a system that may fail to gain public trust when we have a tested, simple, and provably legitimate option right in front of us: Approval voting.
...
RCV, on the other hand, pretends to solve all the problems, giving false promises that lead to similar poor outcomes, and then leaves voters disillusioned and rightly upset when they realize they were lied to.
