...
In the context of electoral systems, this means I am often partial to systems that can provably satisfy many desirable theoretical properties, but more than anything, I value practical solutions that yield strong approximations to the ideal outcomes we would hope to see in a perfect voting system. I was pleasantly surprised to find that Approval voting manages to both satisfy strong theoretical guarantees while also yielding outcomes that are extremely close to more expressive and complex systems like STAR or Condorcet methods.
...
These are the criteria that I personally see as most important when evaluating electoral systems in our current moment in the United States.
