...
Now, I should be up-front that as far as voting systems go, [IRV is far, far worse](../ditch-rcv/){:target="_blank"} than STAR voting. It's not even close.

However, I have been working on a post investigating the manipulability of the [Better Choices voting system](../better-choices/){:target="_blank"} (a form of minimax), and I wanted to design a similar model for IRV. Eventually, I realized that STAR is an even better fit for the model, due to the structural similarities.
