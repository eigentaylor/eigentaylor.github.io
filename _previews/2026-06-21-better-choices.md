...
A Condorcet method is just a voting system (that usually takes in a ranked ballot) and then evaluates the head-to-head matchups between every pair of candidates to determine if there is a Condorcet winner, and then elects them.
...
The choice of three is a very good move, I think. A two-candidate runoff is nice because the race is cognitively simple. You just pick who you like better, and it means you get more time to decide who you think is genuinely better. It's fully strategyproof (in the runoff step)<d-cite key="may1952simpleMajority"></d-cite>, and your vote absolutely counts.
