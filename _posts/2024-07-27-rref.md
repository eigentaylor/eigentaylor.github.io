...
[So why isn't this view emphasized at the beginning of a course so that this generalization to other bases is only a minor change and not something students seem to need to learn from scratch? Why is this viewed as a formula and not the most basic definition?](https://youtu.be/t348e24vDyA?si=k3Df2elcbvqxdcnq)
...
There is another perspective for what an "invertible operator on the left" actually means using ["row perspective"](../columnperspective/#row-perspective). It's essentially the transpose of column perspective.
...
[hyperlink](https://youtu.be/NtiGP0MlF8k?si=T5evvei871Yl76GT)
