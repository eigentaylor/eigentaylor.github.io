...
[In 2024](https://ballotpedia.org/Results_for_ranked-choice_voting_(RCV)_and_electoral_system_ballot_measures,_2024), ranked-choice voting (RCV) explicitly failed to pass in four U.S. states where it was on the ballot: Colorado, Nevada, Idaho, and Oregon. It was preemptively prohibited in Missouri, and a ballot measure in Arizona which could have implemented RCV also failed to pass. RCV only survived in Alaska by some 700 votes (160,230 to repeal, 160,973 to keep), making it a narrow 1:6 for RCV.
