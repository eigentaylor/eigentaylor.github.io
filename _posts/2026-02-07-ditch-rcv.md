...
Ballotpedia. (2024). *Results for ranked-choice voting (RCV) and electoral system ballot measures, 2024*. [Link](https://ballotpedia.org/Results_for_ranked-choice_voting_(RCV)_and_electoral_system_ballot_measures,_2024){:target="_blank"}
