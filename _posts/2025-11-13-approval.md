...
2. There is only one optimal strategy: the sincere strategy where you vote for all candidates you approve of and none that you don't (the system is strategyproof)
