...
4. There will, in fact, be at least one Condorcet winner among the set of winners.
5. AV is actually also (trivially) pareto efficient! If every voter ranks $$A>B$$, then that literally means that every voter approves of $$A$$ and none approves of $$B$$, so $$A$$ must strictly beat $$B$$ (in fact, 100% to 0%). In effect, this is super Pareto efficiency.
