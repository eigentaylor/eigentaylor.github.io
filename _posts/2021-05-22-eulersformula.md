...
Hopefully this is enough to explain Euler's formula for most people. But if you're like me, you may be wondering why $$\cos$$ and $$\sin$$ just *happen* to be here. And in my opinion, the best explanation is that one can **define** $$\cos(x)$$ and $$\sin(x)$$ as the real and imaginary parts of $$e^{ix}$$. The [prologue of the third edition of Walter Rudin’s Real and Complex Analysis](https://59clc.files.wordpress.com/2011/01/real-and-complex-analysis.pdf) does this and manages to *define* $$\pi$$ in terms of the exponential function. It may be difficult to follow, however. If you really want to understand it, the first [thing I ever wrote in LaTeX](https://www.overleaf.com/read/kfgvxfxmsxps) almost two years ago was attempting to make that derivation more intuitive. Note, though, that it was even more poorly written than the posts on this blog (yikes) and remains unfinished.

Rather than go into applications of this formula, I will save those for other posts. The main ones being [skipping integration by parts](../eulersformulabyparts/) for integrals involve the product of an exponential and a trig function, and easy ways to remember trig identities.
