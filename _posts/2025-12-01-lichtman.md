...
There is, however, one important thing to Lichtman's credit. Comparing his published predictions from 2012 to 2016 gives something striking. In 2012, he *specifically* says Democrats are predicted to win the **popular vote**. In 2016, he appears to have deliberately removed mention of the popular vote from the final table. This an interesting detail because it puts a slight crinkle in the narrative that he only switched to predicting the electoral college after seeing the results. It suggests another possibility that Lichtman might have had true foresight that Trump would win the election, but might have had some serious doubts about whether he would win the popular vote. And given the state of the polls showing a higher likelihood that Clinton would sweep the popular vote, this is understandable. He was basically boxed in by the popular vote distinction, but also genuinely believed Trump would defy the odds. He still includes the same quote in the 2016 prediction that the keys predict the popular vote and not the tally in individual states, but there does appear to be some hedging.

In my estimation, there are three likely scenarios here:

1. Lichtman believed Trump would win the election as his keys indicated, but had some doubts about whether he would win the popular vote. The 2016 call is truly the landmark prediction he claims it is, and deserves genuine credit. But to be completely transparent about the nature of his prediction would cast doubt on his keys, because he was deliberately going against what he had been saying for years: the the keys only predict the popular vote. This would mean Lichtman recognized his prediction might completely contradict his model's explicit definition and parameters, as defined by him, so that 2000 can be considered correct, and potentially prepared to move the goalpost preemptively.
2. The appearance of hedging is a mirage. Lichtman truly believed Trump would win the popular vote (alongside the electoral college), and only after seeing the results did he decide to change his model to only predicting the Electoral College to fit the results.
3. Before the election, Lichtman changed what his model predicted without modifying the methodology (somehow bypassing all previously given reasons why he stated he could not do this). Either this was before his published prediction, in which he either forgot or deliberately neglected to mention this crucial change, or it was after the prediction was published and he simply did not say he was doing so publicly. He only buried a mention of this change deep into his book and never mentions elsewhere that he did this. 

There is no winning scenario for Lichtman here, as all scenarios involve moving the goal post or some level of deception. The narrative that Lichtman posits is not supported by evidence and is contradicted by his other statements. I personally believe the first scenario, which indicates Lichtman potentially betrayed his model, but gives proper credit to Lichtman as a pundit and predictor. That is, Lichtman is an excellent political analyst who was able to predict the outcome of the 2016 election. But his keys are not a scientific model that can predict the Electoral College or popular vote with any real rigor or validity.
