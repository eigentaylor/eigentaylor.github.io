...
How many popular vote victories in the last 50 years were not clear in retrospect? I believe for most presidential elections, you can genernally look back and identify clear factors which led to the outcome. I will go more in depth about some of these elections later, in particular the more contentious ones.
...
These are all concepts captured by one or more of Lichtman's keys. And, frankly, I think you could make an argument that if the incumbent party is going to lose the popular vote, then at least *some* of these things are *very* likely to be true.
...
- This evaluation is relatively immutable by campaigning, and is decided long before election day. Thus, it can be predicted ahead of time by evaluating governance.
- If the incumbent party is going to lose the popular vote, then it is likely that a significant number of governance failures have occurred.
- If a significant number of governance failures have occurred, then it is likely that the incumbent party will lose the popular vote.
- Thus, if we can identify a set of governance failures which have historically correlated with the incumbent party losing the popular vote, then we can use these as predictors for the outcome of the popular vote.

Now, I cannot possibly justify that Lichtman's particular 13 keys are the *correct* set of governance failures to use. Nor can I justify that a hard threshold of six keys is a threshold that means anything. But, I do think that the general concept of using governance failures to predict the popular vote is at least somewhat reasonable.
...
I will give a shortned version on certain aspects of their argument, based on my reading of his book.

The prologue of his book reads like someone trying very hard to explain why his prediction of Gore in 2000 was actually correct. It had some dubious claims about "the great swing state of Ohio" using punchcard ballots (I had to check that this was the 2024 edition, and it was), but ultimately it boiled down to "Gore was the actual winner, the election was stolen from him, but even if he WASN'T, my model still predicts just the popular vote, which he won, so it doesn't matter anyway".

And, as I have said before: fair enough. I really do agree that if one wanted to predict a winner of Gore or Bush, then by essentially all metrics besides who was inaugurated, Gore was the clear winner. The problem is that all of the reasons Lichtman gives for why Gore was the correct prediction cast direct doubt on his prediction of Trump in 2016.
...
Now, we should praise Allan's incredible foresight here. He clearly made an incredibly astute and not at all obvious deduction shortly *before* election night, and then his hypothesis was verified and confirmed by the actual results. Truly impressive.

Except, there's no indication that he ever made this deduction before election night. Is it not far more likely that he saw the election results, saw that Trump won the electoral college but lost the popular vote, and then retroactively decided to change his model to fit the results? You may have heard the term "moving the goalpost" before, and that is exactly what this would be.

If so, then this, more than anything else, completely breaks the credibility of Lichtman's keys. He changed what his model measured to fit the results after the fact **without changing any aspect of his methodology**. This is incredibly disingenuous, if not outright **fraudulent**.

It's quite funny to watch Lichtman in interviews try to explain this. In one interview with Kamal Ahmed (which I cannot find again, unfortunately) he shouted at the interviewer to "**STOP**", claiming that he was spreading "misinformation", and threatening to end the interview right then and there.
...
I'd like to focus in on one aspect of the election, which is the swing states. In particular, I don't know how many people expected Trump to win all seven swing states: Arizona, Georgia, Michigan, Nevada, North Carolina, Pennsylvania, and Wisconsin. But he did. And the closest state was Wisconsin, which he won by 0.9%. The rest were won by one to several percentage points.
