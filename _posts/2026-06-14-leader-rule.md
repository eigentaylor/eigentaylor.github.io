...
This is actually a real dynamic we see in real-world Approval elections. In [an analysis of a St. Louis election by Felix Sargent](https://felixsargent.com/democracy/2025/08/29/st-louis-approval-voting.html), we saw around 60% of frontrunner supporters bullet voted, while *over 80%* of voters who supported a non-frontunner also approved another candidate<d-cite key="sargent2025stlouis"></d-cite>. <d-footnote>This example should be taken with a grain of salt, since St. Louis uses a top 2 Approval system, which does not map neatly to the specific single-winner scenario Laslier's paper focuses on. But the observation stands.</d-footnote>
