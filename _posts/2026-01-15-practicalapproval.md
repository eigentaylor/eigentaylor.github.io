...
If you cannot explain to the protester outside the polling place, the grandmother sending you an article about how the election was stolen, or the people frothing when politicians are sowing doubt about the legitimacy of elections, why their candidate who got the most first-place votes didn't win, or how the winner was determined based on complex graph theory or elimination orders, then that method is not practical for real-world use in the United States.
