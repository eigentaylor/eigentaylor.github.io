...
Just 2,893 of the 33,308 voters (8.67%) who ranked Palin-first and Begich-second, less than 3,000, ([4.94% of her first-choice total](https://substack.com/home/post/p-182659376){:target="_blank"}), if changed to Begich-first, would have changed the eliminated candidate to Palin, and elected a Republican instead of a Democrat. That is 2,893 Republican voters, who would just switch the order of the Republican candidates they like, without changing their ranking of the Democrat, changing the outcome from a Democrat to a Republican. That isn't solving the spoiler problem. That's not honoring majority rule. What is even the point of ranking candidates if your full preferences are not taken into account?
...
If you cannot explain to the protester outside the polling place, the grandmother sending you an article about how the election was stolen, or the people frothing when politicians are sowing doubt about the legitimacy of elections, why their candidate who got the most first-place votes didn't win, or how the winner was determined based on complex graph theory or head-to-head match-up results that nobody can verify on a napkin, then that method is not practical for real-world use in the United States.
